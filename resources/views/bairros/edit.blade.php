...
<div class="page-header">
    <div>
        <h1 class="page-title">🍔 Editar Bairro</h1>
        <p class="page-subtitle">
            Preencha os dados para editar um bairro.
        </p>
    </div>
         ...
         @csrf
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    value="{{ old('nome', $bairro->nome) }}"
                    placeholder="Editar o nome do bairro">
                    @error('nome')
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    value="{{ old('valor_frete', number_format($bairro->valor_frete, 2, ',', '.')) }}"
                    placeholder="0,00">
